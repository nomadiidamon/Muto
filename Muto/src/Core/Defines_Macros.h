...
#define MU_BIND_EVENT_FN(fn) [this](auto&&... args) -> decltype(auto) { return this->fn(std::forward<decltype(args)>(args)...); }
...
#define EVENT_CLASS_TYPE(type) static EventType GetStaticType() { return EventType::ET_##type; }\
...
/// @namespace Muto
/// @brief The main namespace for the Muto engine.
namespace Muto {
