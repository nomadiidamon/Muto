...
/// @brief Defines the Renderer class, which is responsible for managing rendering operations in the Muto engine. The Renderer class provides a high-level interface for rendering scenes, submitting draw calls, and managing rendering state.
